...
jQuery(document).ready(function($) {
    ...
    // side widget
    if($(window).width() > 992) {
        $('.widget-icon img').hover(function() {
            $(this).parent('.widget-icon').prev('.widget-title').css('right', '0');
        }, function() {
            $(this).parent('.widget-icon').prev('.widget-title').css('right', '-100%');
        });
    ...
    $('#widget-weather .widget-icon').click(function(event) {
        $('#currency-box').removeClass('animate');
        $('#currency-box').prev('.widget-icon').children('.widget-close').hide();
        $('#currency-box').prev('.widget-icon').children('img').show();

        $(this).next('#weather-box').toggleClass('animate');
        $(this).children('.widget-close').toggle();
        $(this).children('img').toggle();
    });

    $('#widget-currency .widget-icon').click(function(event) {
        $('#weather-box').removeClass('animate');
        $('#weather-box').prev('.widget-icon').children('.widget-close').hide();
        $('#weather-box').prev('.widget-icon').children('img').show();

        $(this).next('#currency-box').toggleClass('animate');
        $(this).children('.widget-close').toggle();
        $(this).children('img').toggle();
    });
    ...
    if($(window).width() < 768) {
        ...
        el.on('scroll', function() {
            ...
            // do something here…
            if(y == 'down') {
                $('#widget-icons').removeClass('animate');
            } else if(y == 'up') {
                $('#widget-icons').addClass('animate');
            }
    ...
    /* select2 init */
    if(page == 'hotels') {
        function setStars(item) {
            if (item.text == 1) {
                item.text = "<i class='fa fa-star'></i>";
            } else if(item.text == 2) {
                item.text = "<i class='fa fa-star'></i><i class='fa fa-star'></i>";
            } else if(item.text == 3) {
                item.text = "<i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star'></i>";
            } else if(item.text == 4) {
                item.text = "<i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star'></i>";
            } else if(item.text == 5) {
                item.text = "<i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star'></i>";
            }
            console.log(item);
            return item.text;
        };
        $(".select2").select2({
            ...
            templateResult: setStars,
            templateSelection: setStars,
    ...
    // all news filtering
    if(page == 'all_news' || page == 'photo_gallery' || page == 'tv' || page == 'tours' || page == 'hotels') {
            ...
            $.ajax({
                ...
                if(page == 'hotels') {
                    for (var i = response.length - 1; i >= 0; i--) {
                        if(response[i].categories) {
                            for (var c = response[i].categories.length - 1; c >= 0; c--) {
                                if(response[i].categories[c]['title_' + config.language] == '1') {
                                    response[i].categories[c]['title_' + config.language] = "<i class='fa fa-star'></i>";
                                } else if(response[i].categories[c]['title_' + config.language] == '2') {
                                    response[i].categories[c]['title_' + config.language] = "<i class='fa fa-star'></i><i class='fa fa-star'></i>";
                                } else if(response[i].categories[c]['title_' + config.language] == '3') {
                                    response[i].categories[c]['title_' + config.language] = "<i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star'></i>";
                                } else if(response[i].categories[c]['title_' + config.language] == '4') {
                                    response[i].categories[c]['title_' + config.language] = "<i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star'></i>";
                                } else if(response[i].categories[c]['title_' + config.language] == '5') {
                                    response[i].categories[c]['title_' + config.language] = "<i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star'></i><i class='fa fa-star'></i>";
                                }
                            }
                        }
                    }
