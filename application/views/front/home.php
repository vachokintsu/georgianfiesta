<?php $this->load->view('front/inc/header.php'); ?>
    ...
    <div class="wrap block-wrap">
        <div class="uk-grid">
            <div class="uk-width-small-1-1 uk-width-medium-6-10 uk-width-large-8-10">
                ...
                <div class="schools-block">
                    ...
                    <div id="schools-carousel" class="schools-carousel">
                        ...
                        <div class="schools-carousel-item">
                            <a href="/hotel/index/<?=$row['slug_'.LANG]?>">
                ...
                <div class="schools-block">
                    <header class="block-header">
                        <h3 class="block-header-title"><?=$translate['tours']?></h3>
                    </header>
                    <div id="tours-carousel" class="schools-carousel">
                        <?php foreach($tours as $row): ?>
                        <div class="schools-carousel-item">
                            <a href="/tour/index/<?=$row['slug_'.LANG]?>">
                                <img src="<?=$row['image']?>" alt="<?=$row['title_'.LANG]?>" title="<?=$row['title_'.LANG]?>">
                                <div class="schools-carousel-item-title-box">
                                    <h3 class="schools-carousel-item-title"><?=$row['title_'.LANG]?></h3>
                                </div>
    ...
    <!-- TESTIMONIALS -->
    <div class="schools-block testimonials-block">
        <div class="wrap">
            <header class="block-header">
                <h3 class="block-header-title"><?=$translate['testimonials']?></h3>
            </header>
            <div data-uk-slideset="{animation: 'slide-horizontal', small: 1, medium: 2, large: 3, autoplay: false, duration: 300}">
                        ...
                        <li>
                            <div class="feedback-card">
                                <div class="feedback-card-head">
                                    <img src="<?=$row['image']; ?>" class="feedback-card-img">
                                    <h3 class="feedback-card-title"><?=$row['title_'.LANG]; ?></h3>
                                    <p class="feedback-card-subtitle"><?=$row['descr_'.LANG]; ?></p>
                                </div>
                            </div>
                        </li>
                        <?php endforeach; ?>
                ...
                <ul class="uk-slideset-nav uk-dotnav uk-flex-center feedback-nav"></ul>
            </div>
        </div>
    </div>
    <!-- TESTIMONIALS END -->
