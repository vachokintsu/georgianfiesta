...
<body class="fixed-navbar fixed-sidebar">
    ...
    <div id="header">
        ...
        <div id="logo" class="light-version">
            <span>
                <a href="<?=base_url()?>" target="_blank">georgianfiesta.ge</a>
            </span>
        </div>
        <nav role="navigation">
    ...
    <aside id="menu">
        <div id="navigation">
            ...
            <ul class="nav" id="side-menu">
                ...
                <li class="<?php if($this->uri->segment(2) == 'hotels') echo "active"; ?>">
                    <a href="<?=site_url('admin/hotels')?>"> <span class="nav-label">სასტუმროები</span> </a>
                </li>
                <li class="<?php if($this->uri->segment(2) == 'hotels_cats') echo "active"; ?>">
                    <a href="<?=site_url('admin/hotels_cats')?>"> <span class="nav-label">სასტუმროების კატეგორიები</span> </a>
                </li>
                <li class="<?php if($this->uri->segment(2) == 'tours') echo "active"; ?>">
                    <a href="<?=site_url('admin/tours')?>"> <span class="nav-label">ტურები</span> </a>
                </li>
                <li class="<?php if($this->uri->segment(2) == 'tours_cats') echo "active"; ?>">
                    <a href="<?=site_url('admin/tours_cats')?>"> <span class="nav-label">ტურის კატეგორიები</span> </a>
                </li>
                ...
                <li class="<?php if($this->uri->segment(2) == 'sidebar') echo "active"; ?>">
                    <a href="<?=site_url('admin/sidebar')?>"> <span class="nav-label">საიდბარი</span> </a>
                </li>
                ...
                <!-- <li class="<?php if($this->uri->segment(2) == 'schools') echo "active"; ?>">
                    <a href="<?=site_url('admin/schools')?>"> <span class="nav-label">სკოლები</span> </a>
                </li> -->
                <li class="<?php if($this->uri->segment(2) == 'testimonials') echo "active"; ?>">
                    <a href="<?=site_url('admin/testimonials')?>"> <span class="nav-label">გამოხმაურებები</span> </a>
                </li>
                <li class="<?php if($this->uri->segment(2) == 'photo_gallery') echo "active"; ?>">
                    <a href="<?=site_url('admin/photo_gallery')?>"> <span class="nav-label">ფოტო გალერეა</span> </a>
                </li>
                <li class="<?php if($this->uri->segment(2) == 'multimedia_tv') echo "active"; ?>">
                    <a href="<?=site_url('admin/multimedia_tv')?>"> <span class="nav-label">ვიდეო გალერეა</span> </a>
                </li>
                <li class="<?php if($this->uri->segment(2) == 'multimedia_tv_cats') echo "active"; ?>">
                    <a href="<?=site_url('admin/multimedia_tv_cats')?>"> <span class="nav-label">ვიდეო გალერეის კატეგორიები</span> </a>
                </li>
