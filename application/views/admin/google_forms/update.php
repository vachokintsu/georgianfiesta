                        ...
                        <div class="form-group">
                            ...
                            <div>
                                <div class="radio radio-info radio-inline">
                                    <input type="radio" id="show_in_headerY" name="show_in_header" value="1" <?php if($item['show_in_header'] == '1') { echo "checked"; } ?> >
                                    <label for="show_in_headerY">დიახ</label>
                                </div>
                                <div class="radio radio-info radio-inline">
                                    <input type="radio" id="show_in_headerN" name="show_in_header" value="0" <?php if($item['show_in_header'] == '0') { echo "checked"; } ?> >
