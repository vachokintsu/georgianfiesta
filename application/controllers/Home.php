...
class Home extends CI_Controller {
	...
	function __construct() {
		parent::__construct();
		$this->load->model(array('Front_model', 'Front_home_model', 'Front_news_model', 'Front_announcements_model', 'Front_hotels_model', 'Front_tours_model'));
	}
	...
	public function index()
	{
		...
		$data['feedback'] = $this->Front_home_model->feedback();
		...
		/* SCHOOLS */
		$data['hotels'] = $this->Front_hotels_model->home_hotels(16);
		/* tours */
		$data['tours'] = $this->Front_tours_model->home_tours(16);
		/* BANNERS */
