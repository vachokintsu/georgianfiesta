...
class Hotels_cats_ad_model extends CI_Model {

	public function read_parents() {
		$this->db->select('id, title_ge, sort');
		$this->db->from('hotels_cats');
	...
	public function update_sorting() {
		$hotels_cats_data = $this->input->get('hotels_cats');

		foreach ($hotels_cats_data as $key) {
